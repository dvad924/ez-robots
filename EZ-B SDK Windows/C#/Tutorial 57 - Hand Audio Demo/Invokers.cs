...
public class Invokers {
  ...
  delegate bool GetCheckedCallbackRB(RadioButton control);
  public static bool GetCheckedValue(RadioButton control) {

    try {
      if (control.InvokeRequired) {

        GetCheckedCallbackRB d = new GetCheckedCallbackRB(GetCheckedValue);
